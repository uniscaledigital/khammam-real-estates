...
export function FloatingActions() {
  ...
  return (
    <div 
      className={`fixed bottom-8 right-8 z-[9999] flex flex-col gap-4 transition-all duration-300 ease-in-out md:bottom-10 md:right-10 ${
    ...
    >
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#D4AF37] text-white shadow-[0_12px_30px_rgba(0,0,0,0.18)] transition-all duration-300 ease-in-out hover:scale-[1.08] hover:shadow-[0_15px_35px_rgba(212,175,55,0.4)] md:h-16 md:w-16"
      >
      ...
      <a
        href="tel:8186871820"
        aria-label="Call Now"
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#2563EB] text-white shadow-[0_12px_30px_rgba(0,0,0,0.18)] transition-all duration-300 ease-in-out hover:scale-[1.08] hover:shadow-[0_15px_35px_rgba(37,99,235,0.4)] md:h-16 md:w-16"
      >
      ...
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_30px_rgba(0,0,0,0.18)] transition-all duration-300 ease-in-out hover:scale-[1.08] hover:shadow-[0_15px_35px_rgba(37,211,102,0.4)] md:h-16 md:w-16"
      >
