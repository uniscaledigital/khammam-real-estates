    ...
    <article className="group relative flex flex-col overflow-hidden rounded-[20px] border border-primary/40 bg-[#FAF7EF] shadow-md transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_10px_30px_rgba(212,175,55,0.15)]">
      ...
      <div className="flex flex-1 flex-col p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h3 className="font-display text-xl font-bold text-secondary line-clamp-1">{project.name}</h3>
        ...
        <div className="mt-4 mb-5 border-l-2 border-primary pl-3">
          {project.price ? (
        ...
        <div className="mt-auto flex flex-col gap-3 sm:flex-row">
          <Link 
            ...
            className="flex flex-1 items-center justify-center gap-1.5 rounded-full bg-primary px-4 py-2.5 text-sm font-bold text-secondary shadow-sm transition-all hover:bg-brand"
          >
          ...
          <div className="flex gap-2">
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center rounded-full bg-[#25D366] p-2.5 text-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md"
              aria-label="WhatsApp"
            >
            ...
            <a 
              ...
              className="flex items-center justify-center rounded-full border border-primary bg-transparent p-2.5 text-primary shadow-sm transition-all hover:-translate-y-0.5 hover:bg-primary hover:text-secondary"
              aria-label="Call"
            >
